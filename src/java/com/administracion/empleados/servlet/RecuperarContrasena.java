...
public class RecuperarContrasena extends HttpServlet {
    ...
    private Passwords password = new Passwords();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {     
        String userempleado = request.getParameter("UserEmpleado");
        
   if(password.IsUsernameValid(userempleado) && loginempleado.IsUserRegistered(userempleado)){
