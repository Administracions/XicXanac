...
public class Administrador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
     ...
     idempleado = loginempleado.getIdByUsername(userempleado);
        
        com.entity.pojos.Administrador informacionAdministracion =  administrador.findByIdEmpleado(idempleado);
   
   if(informacionAdministracion != null){
   request.setAttribute("informacionAdmin", informacionAdministracion);
   request.getRequestDispatcher("/Empleados/AdministradorInfo.jsp").forward(request, response);
