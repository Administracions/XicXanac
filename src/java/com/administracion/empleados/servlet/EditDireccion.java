 ...
 * @author PC
 */
@WebServlet(name = "EditDireccion", urlPatterns = {"/EditDireccion"})
public class EditDireccion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditDireccion</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditDireccion at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      if(direccion != null){
          ...
          request.setAttribute("Estados", Estados.values());
          request.getRequestDispatcher("/Empleados/EditarDireccion.jsp").forward(request, response);
