...
private Direccion direccionempleado;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        EmpleadoService.getDireccionempleado(request, response);
        direccionempleado = EmpleadoService.fillDireccionempleadosfields();   
        if(direccionempleado != null){
        session.setAttribute("direccion", direccionempleado);
