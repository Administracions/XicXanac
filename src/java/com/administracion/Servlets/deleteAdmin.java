...
public class deleteAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      Administrador administrador =  this.administrador.find(idAdmin);
      
      if(administrador != null){     
          this.administrador.remove(administrador);
          mensaje = "Ha sido borrado exitosamente  el Administrador con id: " + idAdmin;
          
      }else{
         
          mensaje = "No existe el Administrador con id " + idAdmin + ".Ya fue borrado";
