 ...
 * @author PC
 */
public class CargoEdited extends HttpServlet {
 ...
 private Cargoss cargo;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      AreaCargo   = request.getParameter("AreaCargo");
     
       
     Cargo cargo = this.cargo.find(idCargo);
     cargo.setArea(AreaCargo);
     cargo.setCargo(NombreCargo);
     
  this.cargo.edit(cargo);
   
request.setAttribute("listacargos", this.cargo.findAll());
